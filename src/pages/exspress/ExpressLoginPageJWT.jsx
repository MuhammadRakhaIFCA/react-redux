...
const ExpressLoginPageJWT = () => {
    ...
    const handleLogin = async (values) => {
        try {
            const result = await axiosExpress.post("/users/login/jwt", {
            ...
            alert(`username : ${result.data.username} id : ${result.data.id}`)
            navigate('/test')
        } catch (error) {
            console.log(error)
        }
...
export default ExpressLoginPageJWT