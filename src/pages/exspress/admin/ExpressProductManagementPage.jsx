...
const ExpressProductManagementPage = () => {
    ...
    const fetchProduct = async () => {
        ...
        try {
            const response = await axiosExpress.get("/products/page", {
                params: {
                    _per_page: 5,
    ...
    const handleDeleteProduct = async (productId) => {
        ...
        const deletePromises = selectedProductIds.map((selectedProductId) => {
            return axiosExpress.delete("/products/delete/" + selectedProductId) //ini di return dimasukkin ke array deletePromise
        })
        ...
        <AdminLayout
            ...
            rightSection={
                <div className="flex gap-2">
                    ...
                    <Link to="/express/admin/products/create">
                        <Button >
                        ...
                        products.map((product) => {
                            return (
                                <TableRow>
                                    ...
                                    <TableCell>
                                        <Link to={"/express/admin/products/edit/" + product.id}>
...
export default ExpressProductManagementPage